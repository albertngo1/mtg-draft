...
### White
- [**Novice Inspector**](https://scryfall.com/search?q=Novice%20Inspector) — Best white common (retro). Thraben Inspector functional reprint; never cut, even splashable. (preview, retro)
- [**Makeshift Binding**](https://scryfall.com/search?q=Makeshift%20Binding) — Premium white removal (O-Ring + gain 2 life). The "extra value" makes it beat ward-2 evaluation. Ethan's #1 common overall. (02-07, 03-05, retro)
- [**Perimeter Enforcer**](https://scryfall.com/search?q=Perimeter%20Enforcer) — Strong white aggressive uncommon, P1-pickable. 1/1 flying lifelink that grows when Detectives ETB / flip up. A key good two-drop. (02-07, 03-05, retro)
- [**On the Job**](https://scryfall.com/search?q=On%20the%20Job) — ⚠ Underrated → premium. Overrun-style go-wide payoff that ties white go-wide decks together; even better drawing a Clue. Better in WU; Out Cold does a similar job — don't sweat which you get. (retro)
- [**Inside Source**](https://scryfall.com/search?q=Inside%20Source) — Incredible in WB: 3-mana 1/1 that brings a 2/2 token and pumps Detectives. Go-wide engine. (02-07)
- [**Neighborhood Guardian**](https://scryfall.com/search?q=Neighborhood%20Guardian) — Solid WB/WU go-wide flyer-anthem piece. (02-07, 03-05)
- [**No Witnesses**](https://scryfall.com/search?q=No%20Witnesses) — WW wrath; a devastating, swingy combat/board blowout. Play around it in close aggro spots. Fair overall (Clues help recovery). (preview, 03-05, retro)
- [**Not on My Watch**](https://scryfall.com/search?q=Not%20on%20My%20Watch) — ⚠ Preview liked it (exile attacker); retro says **unplayable for white** — wrong timing, opposite of white's proactive plan. (preview → retro)
- [**Granite Witness**](https://scryfall.com/search?q=Granite%20Witness) — Good WU body/fixing-ish hybrid; wheels often (signal the WU lane is open). Escape Tunnel beats it for fixing. (03-05, retro)
- [**Call a Surprise Witness**](https://scryfall.com/search?q=Call%20a%20Surprise%20Witness) — Value recursion of cheap creatures (WU). (03-05)
- [**Aurelia's Vindicator**](https://scryfall.com/search?q=Aurelia%27s%20Vindicator) — Mythic bomb; maybe better than Esika. (retro)
- [**Aelia, Ardent Inquisitor**](https://scryfall.com/search?q=Aelia%2C%20Ardent%20Inquisitor) — Clear powerful P1P1 (Boros legend). (03-06)

### Blue
- [**Projector Inspector**](https://scryfall.com/search?q=Projector%20Inspector) — ⚠ Best blue common (retro) but repeatedly called **"wildly underrated"** in-format. Investigate-on-attack Detective; excellent w/ go-wide and extra Detectives. Doubling it is great with Analyst. (03-05, retro)
- [**Fairy Snoop (Faerie Snoop)**](https://scryfall.com/search?q=Fairy%20Snoop%20%28Faerie%20Snoop%29) — ⚠ Preview/early hype as a top common; reality = flexible & strong but **mana-hungry, diminishing returns, and NOT great in tempo Detectives.** "Too many Snoops" is real. (preview, 02-07)
- [**Out Cold**](https://scryfall.com/search?q=Out%20Cold) — 3-mana tap-two + investigate. Strong, but needs enough early plays. **Best home is Simic (GU)**; Out Cold > Lost in the Maze. (preview, retro)
- [**Private Eye**](https://scryfall.com/search?q=Private%20Eye) — Bounce + tempo; anthem/unblockable Detective payoff. (preview, 03-05)
- [**Reasonable Doubt**](https://scryfall.com/search?q=Reasonable%20Doubt) — Good tempo/counter-style trick; useful vs card-advantage engines (Outrageous Robbery). (03-05, 03-06)
- [**Deduce**](https://scryfall.com/search?q=Deduce) — Think-twice variant, fine card-flow. (preview)
- [**Seasoned Consultant**](https://scryfall.com/search?q=Seasoned%20Consultant) — Good blue/WU two-drop backbone. (03-05, retro)
- [**Analyst**](https://scryfall.com/search?q=Analyst) — Great with double Projector Inspector. (03-05)
- [**Cryptic Coat**](https://scryfall.com/search?q=Cryptic%20Coat) — Strong rare (UR/blue). (retro)
- [**Doppelgang**](https://scryfall.com/search?q=Doppelgang) — Great rare. (retro)

### Black
- [**Extract a Confession**](https://scryfall.com/search?q=Extract%20a%20Confession) — Best black common (retro). Efficient edict — bypasses ward 2. (preview, retro)
- [**Long Goodbye**](https://scryfall.com/search?q=Long%20Goodbye) — Strong UB instant removal (kills MV≤3), great vs cheap disguise flips. ⚠ Caveat: gets **awkward late** since a flipped MV-4+ creature blows you out. (preview, retro)
- [**Murder**](https://scryfall.com/search?q=Murder) — ⚠ Contested. Ben: still great (best in UB control). Ethan: only C+ ("Boomer showing"). Retro verdict: **fine but unexciting on ladder; better in high-level pod play.** "A magic card" — premium straightforward removal when black opens. (preview, 03-06, retro)
- [**Leering Onlooker**](https://scryfall.com/search?q=Leering%20Onlooker) — "Lingering Souls on defense" — great surveil/mill target, self-recur for Roots/Outline. Banger black uncommon. (preview, retro)
- [**Night Drinker Moroii**](https://scryfall.com/search?q=Night%20Drinker%20Moroii) — ⚠ Big disagreement: Ben B / Ethan D. Retro: **Slimy Dualist > Night Drinker Moroii.** Leans toward Ethan's low read. (preview, retro)
- [**Slimy Dualist**](https://scryfall.com/search?q=Slimy%20Dualist) — Better than Night Drinker Moroii; real home in Orzhov (WB). (retro)
- [**Cornered Crook**](https://scryfall.com/search?q=Cornered%20Crook) — > Undercity Eliminator (Crook can go face). Neither is a Flametongue Kavu — ward 2 blunts both. (retro)
- [**Undercity Eliminator**](https://scryfall.com/search?q=Undercity%20Eliminator) — Just a 5-mana 3/3; below Cornered Crook. (preview, retro)
- [**Fester-Leech / Fester Leech**](https://scryfall.com/search?q=Fester-Leech%20/%20Fester%20Leech) — Strong CE/self-mill one-drop enabler — but enablers are just bodies without payoffs. (preview, 02-07)
- [**Soul Enervation**](https://scryfall.com/search?q=Soul%20Enervation) — Cheap black interaction (WB). (02-07)
- [**Deadly Cover-Up**](https://scryfall.com/search?q=Deadly%20Cover-Up) — BB 5-mana wrath; hard to build around, **best in Dimir (UB).** (preview, retro)

### Red
- [**Shock**](https://scryfall.com/search?q=Shock) — Best red common (retro). Premium vs ~46% T2 creatures; can ambush face-down 2/2s; instant-speed. Ben took Shock over Lightning Helix at P4 for **color flexibility** (keeps UR open vs Helix locking RW). (01-29, 02-07, retro)
- [**Lightning Helix**](https://scryfall.com/search?q=Lightning%20Helix) — "Disgusting" Boros removal + reach. Premium but color-committing. (preview, 02-07, retro)
- [**Galvanize**](https://scryfall.com/search?q=Galvanize) — ⚠ Preview/early: top-tier (deal 3, or 5 if drawn 2+; crack a Clue first). Retro: **only average** (4 mana to kill a disguised creature). Reality < hype. (preview, 01-29, retro)
- [**Torch the Witness**](https://scryfall.com/search?q=Torch%20the%20Witness) — Premium common removal alongside Makeshift Binding. (03-05)
- [**Felonious Rage**](https://scryfall.com/search?q=Felonious%20Rage) — Situational burn; passed early as too narrow / hidden power. (03-06)
- [**Krenko / Thopter Fabrication / Decimator Dragon**](https://scryfall.com/search?q=Krenko%20/%20Thopter%20Fabrication%20/%20Decimator%20Dragon) — UR artifact-deck haymakers; fastest unbeatable starts. (retro)
- [**Connecting the Dots**](https://scryfall.com/search?q=Connecting%20the%20Dots) — ⚠ Narrowly powerful, mostly a Rakdos (RB) gold card; Case of the Crimson Pulse does it better. **Ignore its dumpster 17Lands stats** BUT "never play it" is more right than wrong. (retro) — note: rare case where retro says ignore the data.
- [**World Soul's Rage**](https://scryfall.com/search?q=World%20Soul%27s%20Rage) — Red splash finisher (BG splash R). (03-06)

### Green
- [**Nervous Gardener**](https://scryfall.com/search?q=Nervous%20Gardener) — Best green common *early* (fixing + disguise that fetches a basic); a top fixing enabler for splashes. Shifts to Lochthwain Eavesdropper once you're in the right synergy deck. (preview, retro)
- [**Lochthwain Eavesdropper**](https://scryfall.com/search?q=Lochthwain%20Eavesdropper) — Great (4-mana 3/3 feels fine in a 3-mana-2/2 format); best green common once in synergy. (retro)
- [**Topiary Panther**](https://scryfall.com/search?q=Topiary%20Panther) — Cycles + loads evidence; "every piece of the buffalo" exemplar; clunky overperformer conversation. (preview, retro)
- [**Bite Down on Crime**](https://scryfall.com/search?q=Bite%20Down%20on%20Crime) — ⚠ Preview: weak (4-mana sorcery fight, needs setup). Re-evaluated UP: fight bypasses ward 2 AND collects evidence — even small CE inclusions are good. (preview → 01-29, retro)
- [**Vengeful Creeper**](https://scryfall.com/search?q=Vengeful%20Creeper) — Green 5-mana 5/5 that flips to blow up artifact/enchantment; great, always had targets; clunky-overperformer. (retro)
- [**Greenbelt Radical**](https://scryfall.com/search?q=Greenbelt%20Radical) — RG disguise payoff: 4/4 that on flip puts +1/+1 on each of your creatures + trample. (preview)
- [**Insidious Roots**](https://scryfall.com/search?q=Insidious%20Roots) — Build-around BG payoff (creatures leaving yard make plant tokens). Headliner build-around. (01-29, retro)
- [**Tunnel Tipster**](https://scryfall.com/search?q=Tunnel%20Tipster) — Ramps but does little else; cuttable if you don't need ramp. (03-06)
- [**Slime Against Humanity**](https://scryfall.com/search?q=Slime%20Against%20Humanity) — Build-around; needs ooze/named copies in exile to scale — easy to misread. (preview)
- [**Grave Titan Strider (Strider)**](https://scryfall.com/search?q=Grave%20Titan%20Strider%20%28Strider%29) — Golden Egg co-winner: higher-ceiling green/late-game/splash payoff. (retro)
- [**Undergrowth Recon**](https://scryfall.com/search?q=Undergrowth%20Recon) — "Stinker" rare (healthy bad rare). (retro)

### Multicolor / gold
- [**Dog Walker (RW)**](https://scryfall.com/search?q=Dog%20Walker%20%28RW%29) — ⚠ Best hybrid common (Ethan: slightly *over*-loved; "second-best common after Makeshift Binding"). X/1 dodges the no-1-toughness-removal gap. Notably **worse outside RW but never cut from GW.** Often plays better cast full-cost on a do-nothing turn. (preview, 01-29, 02-07, retro)
- [**Gadget Technician (UR)**](https://scryfall.com/search?q=Gadget%20Technician%20%28UR%29) — Top hybrid gold common (preview/early hype). Strong in UR artifacts. (preview, 01-29)
- [**Sanguine Savior (WB)**](https://scryfall.com/search?q=Sanguine%20Savior%20%28WB%29) — Top-tier hybrid gold common (early); ⚠ passed early as situational/hidden-power in one late draft. (preview, 03-06)
- [**Push // Pull**](https://scryfall.com/search?q=Push) — Top early uncommon (hybrid flexibility); "Pull" ends games + massive value. Only drops if you can't cast both halves. (retro)
- [**Fuss // Bother**](https://scryfall.com/search?q=Fuss) — Go-wide payoff Azorius (WU) wants; great w/ flyers + token-makers. (03-05)
- [**Wisp-Drinker Vampire (WB)**](https://scryfall.com/search?q=Wisp-Drinker%20Vampire%20%28WB%29) — 4-mana 2/4 flyer; drains + grants lifelink/deathtouch when a power-2-or-less creature ETBs. WB pint-size payoff. (02-07)
- [**Meddling Youths (RW)**](https://scryfall.com/search?q=Meddling%20Youths%20%28RW%29) — Good Boros signpost (but not why Boros is great). (preview, retro)
- [**Aurelia**](https://scryfall.com/search?q=Aurelia) — Boros bomb (rare/mythic), raw power finisher. (02-07)
- [**Kaya**](https://scryfall.com/search?q=Kaya) — Splashable WB planeswalker bomb. (02-07)

### Cases (enchantments)
- [**Case of the Gateway Express**](https://scryfall.com/search?q=Case%20of%20the%20Gateway%20Express) — Best non-rare Case; cheap white go-wide payoff, good in most white/aggro decks. **Won't wheel.** (preview, 01-29, 02-07, retro)
- [**Case of the Filched Falcon**](https://scryfall.com/search?q=Case%20of%20the%20Filched%20Falcon) — UR-only; turn a Clue into a 4/4 flyer; oppressive into Gleaming Geardrake. (preview, 01-29, retro)
- [**Case of the Shattered Pack**](https://scryfall.com/search?q=Case%20of%20the%20Shattered%20Pack) — Easy to solve via hybrid commons; fixes + grants flying/double strike/vigilance. (01-29)
- [**Case File Auditor**](https://scryfall.com/search?q=Case%20File%20Auditor) — Digs for enchantments / fixes for Case spells. (01-29)
- [**Case of the Locked Hot House**](https://scryfall.com/search?q=Case%20of%20the%20Locked%20Hot%20House) — Huge range: sometimes dead, sometimes wins games nothing else could. (retro)
- [**Case of the Burning Masks**](https://scryfall.com/search?q=Case%20of%20the%20Burning%20Masks) — Removal that can draw — the "extra value" beats ward-2 eval. (retro)
- [**Case of the Crimson Pulse**](https://scryfall.com/search?q=Case%20of%20the%20Crimson%20Pulse) — Does Connecting the Dots' job better (RB). (retro)
...
### Colorless / artifacts
- [**Smuggler's Copter**](https://scryfall.com/search?q=Smuggler%27s%20Copter) — The premium colorless pickup (P1P1-tier). ⚠ Caveat: in 03-06 it was the drafter's *one regret* — taken while uncertain on colors, then drifted into a build (graveyard Golgari) that couldn't crew/support it. **Take it, but be honest whether your final deck supports the body/crew.** (Note: "Satchel" appears as a caption alias — see caveats.) (02-07, 03-06)
- [**Sanitation Automaton**](https://scryfall.com/search?q=Sanitation%20Automaton) — Golden Egg co-winner: universal "glue card," high floor, goes in any deck; can give Esika hexproof. A good two-drop in a format short on them. (retro)
- [**Detective's Satchel**](https://scryfall.com/search?q=Detective%27s%20Satchel) — ⚠ Contested gradation gap in preview; reality = powerful grindy value engine, esp. doubled in a Rakdos splash (with Cranko + Thopters). (preview, 03-05)
- [**Cryptic Coat**](https://scryfall.com/search?q=Cryptic%20Coat) — Strong colorless/blue rare. (retro)
- [**Thinking Cap**](https://scryfall.com/search?q=Thinking%20Cap) — 1-mana Detective equip; fine but **over-committing to "augmentation" is a trap** — cut Thinking Cap for cheap interaction (Make Your Move) won a draft. (preview, 03-05)
- [**Make Your Move**](https://scryfall.com/search?q=Make%20Your%20Move) — Cheap flexible interaction; key main-deck add when short on answers. (03-05)
- [**Clue/equipment "weapons"**](https://scryfall.com/search?q=Clue/equipment%20%22weapons%22) — Flavor win, gameplay fail — none worth playing. (retro)
- [**Pick the Players**](https://scryfall.com/search?q=Pick%20the%20Players) — Maindeckable; board-friendly, doubles as removal/answers; SB-in vs artifacts/enchantments. (03-06)

### Lands / fixing
- [**Escape Tunnel**](https://scryfall.com/search?q=Escape%20Tunnel) — ⚠ UNDERRATED → arguably a **top-10 common.** Best fixing in the set; great for splashes + double-color requirements (ahead of Granite Witness). (retro)
- [**Public Thoroughfare**](https://scryfall.com/search?q=Public%20Thoroughfare) — Mediocre; best in Grixis-ish UR only. (preview, retro)
- [**Scene of the Crime**](https://scryfall.com/search?q=Scene%20of%20the%20Crime) — ⚠ Preview: real playable (artifact Clue land). Retro: unplayable. (preview → retro)
- [**Branch of Vitu-Ghazi**](https://scryfall.com/search?q=Branch%20of%20Vitu-Ghazi) — Unplayable (colorless land + disguise 3 not worth it). (preview, retro)
- [**Treacherous Terrain (~treacherous terrain)**](https://scryfall.com/search?q=Treacherous%20Terrain%20%28~treacherous%20terrain%29) — Fine as a red-splash finisher + fixing (cycles for basics, dumps ~8 cards/evidence) despite being on an online "restricted-from-decks" list / rare in paper. (03-06) — ⚠ name uncertain, see caveats.

### Rares / bombs
- [**Esika, Center of the Web**](https://scryfall.com/search?q=Esika%2C%20Center%20of%20the%20Web) — **Best rare** in a deep, balanced rare pool. (retro)
- [**Aurelia's Vindicator**](https://scryfall.com/search?q=Aurelia%27s%20Vindicator) — Mythic, maybe better than Esika. (retro)
- [**Esika's Agency Chief**](https://scryfall.com/search?q=Esika%27s%20Agency%20Chief) — Can sac enemy artifacts (not just Clues); pair w/ Sanitation Automaton to give Esika hexproof. (retro)
- [**Incinerator of the Guilty / Ill-Timed Explosion**](https://scryfall.com/search?q=Incinerator%20of%20the%20Guilty%20/%20Ill-Timed%20Explosion) — Fair wraths/bombs. (preview, retro)
- [**Stinker rares (healthy):**](https://scryfall.com/search?q=Stinker%20rares%20%28healthy%29%3A) A Fisher's Interrogation, Treacherous Greed, Relive the Past, Case of the Ransacked Lab, Undergrowth Recon. (retro)
- [**Wraths overall**](https://scryfall.com/search?q=Wraths%20overall) — Everywhere but fair; didn't feel oppressive (Clues aid recovery). (retro)
