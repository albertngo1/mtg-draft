...
|------|--------------|-------|--------|
| 2020-09-11 | Zendikar Rising Review: White | Preview (blind) | Very low — predictions only |
| 2020-09-11 | Zendikar Rising Review: Blue | Preview (blind) | Very low — predictions only |
| 2020-09-11 | Zendikar Rising Review: Black | Preview (blind) | Very low — predictions only |
| 2020-09-11 | Zendikar Rising Review: Red | Preview (blind) | Very low — predictions only |
| 2020-09-11 | Zendikar Rising Review: Green | Preview (blind) | Very low — predictions only |
| 2020-09-11 | Zendikar Rising Review: Gold & Colorless | Preview (blind) | Very low — predictions only |

## TL;DR meta read

- **Format speed: expected faster-than-average.** Both hosts predicted the format would be proactive and snowball-y — "not M21 speed but faster than average." Aggressive curve-outs rewarded; few catch-up mechanics. Ethan noted everything incentivizes proactive play, "almost like a Ikoria-ish" feel.
- **Three macro archetypes dominate the draft landscape:** (1) **Party/tribal decks** (clerics, rogues, warriors, wizards), (2) **Kicker decks** (especially blue-green), and (3) **Landfall decks** (white-green, red-green). These three lanes have little overlap — like Ikoria, you commit to a lane early. Blue-white sits in the middle as a pivot/hub color.
- **Best colors (prediction): Blue #1, Black #2, Green #3, White #4, Red #5.** Blue's commons are all excellent tempo tools; black's removal suite is absurdly powerful; green enables multi-color fixing.
- **Best archetypes (prediction):** Black-white Clerics, Blue-red Wizards, Blue-black Rogues, Blue-green Kicker. Warriors rated a distant fourth among tribal decks.
- **Modal double-faced cards (MDFCs) are the defining innovation.** Every spell that's also a land dramatically improves consistency. "Think of them as lands that have spells on them, not spells with lands on the back." The expensive MDFCs are the best ones — a great late-game spell is also always a land in your opener. Rate the expensive b-minus/b ones very highly.
- **Removal quality is exceptional in black**, with Deadly Allure (?) ("deadly lines" — cheap scalable murder), Blood Chief's Thirst (unconditional at 4 mana or kills 2-drops for 1), Vanquish the Weak (B-minus, kills most things), and Hagra Mauling (destroy target creature MDFC). Red has Thundering Rebuke (deal 4, uncommon) and Roil Eruption (2 mana deal 3 common, very good). **Don't let the format's speed catch you with weak removal.**
- **Party mechanic: assume party of two** as your baseline when evaluating party cards; full party (all four types) is very hard to assemble outside of dedicated multi-color green builds. Blue-white is the easiest hub because it gets the widest spread of creature types (clerics + wizards + rogues/warriors across both colors).

## Archetype / color-pair tiers

Evidence is THIN (blind preview only). Rankings based on card density observed across color reviews.

| Pair | Colors | Tier | Game plan | Key commons/uncommons | Notes |
|------|--------|------|-----------|----------------------|-------|
| **Dimir Rogues** | UB | **A** | Tempo + mill to 8-card threshold; flash threats, tap-down, unblockable; kill with damage or decking | Into the Royal, Bubble Snare, Sea-Floor Stalker, Skydancer (?) (BU flyer + mill), Shadow Stinger, Soaring Thief (UB uncommon), Nighthawk Scavenger | Blue-black rated joint-best tribal; excellent crossover between tempo and mill subtheme. Full rogue tribal deck OR party deck both supported. |
| **Azorius Party / Tempo** | WU | **A** | Tempo, low-curve, go-wide party + equipment; blue tempo tools + white aggro bodies | Into the Royal, Fearless Fledgling, Canyon Jerboa, Allied Assault, Kitefail Cleric (?), Luminarch Aspirant | "Hub" colors — easiest to pivot into any other archetype. Blue-white has widest creature-type spread for party. Tempo NOT control. |
| **Orzhov Clerics** | WB | **A** | Life-gain synergies + drain triggers; grindy aggro with recursive value; equipment sub-theme | Expedition Healer, Core Celebrant, Attended Healer, Marauding Blight-Priest, Scion of the Swarm, Cleric of Life's Bond (UB uncommon gold), Relic Vial, Null Priest of Oblivion | Cleric payoffs at common look very strong; "the cleric deck looks good to me — a lot of support at common." Best life-gain synergy archetype. |
| **Izzet Wizards** | UR | **A** | Spell-matters + wizard tribal; prowess-style + pinging; Blue-red is classic tempo | Chilling Trap, Risen Riptide, Wind-Rider Wizard, Umara Wizard (?), Rockslide Sorcerer (pings 1 for each instant/sorc/wizard), Magmatic Channeler, Umar Mystics (gold uncommon) | Rockslide Sorcerer rated b-plus and called one of best uncommons in set. "Blue looked very very good." |
| **Simic Kicker** | GU | **A** | Ramp into expensive kicker payoffs; multi-land drops; Vine Gecko engine | Vine Gecko, Balagan Recovery (Regrowth MDFC), Into the Royal, Coral Helm Chronicler, Risen Riptide, Roost of Drakes, Tangled Florohedron (?), Little Mage's Familiar (gold uncommon) | "The kicker deck has a lot of support." Vine Gecko compared to Flourishing Fox (Ikoria). Ethan most excited about this archetype. Blue-green kicker likely to be 3-color. |
| **Rakdos Party** | BR | **B** | Aggressive party + red removal + black disruption; best equipped for "full party" among 2-color | Roil Eruption, Thundering Rebuke, Vanquish the Weak, Blood Chief's Thirst, Malicious Blood-Priest, Drawn from Dreams (?), Zagros (4-drop flyer death-touch haste gold) | Red-black rated as the pair most likely to assemble full party naturally. Warriors + rogues heavy. Ethan was "sad" the party deck didn't look more powerful. |
| **Selesnya Landfall** | GW | **B** | Aggressive landfall creatures with equipment/pumps; Canyon Jerboa as key engine; multi-land-drop package | Canyon Jerboa, Fearless Fledgling, Territorial Scythecat (?), Prowling Felidar, Skyclave Pickaxe, Murasa Rootgrazer (GW uncommon), Colony Ambush (fight MDFC) | Both hosts less excited about pure landfall than expected going in. "Landfall needs a lot of the good landfall cards — the synergies don't run as deep." Better as a green-white splash. |
| **Golgari Counters** | BG | **B-** | +1/+1 counters synergy; grindy value; Iridescent Hornbeetle engine; Skyclave Shadowcat draw engine | Hagra Constrictor, Oran-Rief Ooze, Swarm Shambler, Skyclave Shadowcat, Moss-Pit Skeleton (BG gold), Iridescent Hornbeetle, Inscription of Abundance | Hosts skeptical this is a real top archetype; green-black counters "feels like the deck you get pushed into if you're not assertive enough." Still functional. |
| **Boros Warriors** | RW | **C** | Warrior tribal lord + equipment; aggressive go-wide | Expedition Champion, Kargan Warleader (RW lord uncommon), Fireblade Charger, Akiri Fearless Voyager (RW rare), Nahiri (RW planeswalker rare), Relic Axe | Warriors rated "distant fourth" among tribal archetypes. Kargan Warleader is the first warrior card either host got excited about. Nahiri (planeswalker) is the real reason to be in Boros. |
| **Gruul Landfall** | RG | **C** | Pump landfall creatures and attack; Brushfire Elemental as payoff | Skyclave Geopede, Brushfire Elemental (RG gold), Spitfire Lagac (?), Kazandu Mammoth | Both hosts skeptical of red-green landfall as a primary archetype; "I'm quite skeptical of the red-green landfall deck." Fine as a secondary color but not the best landing zone. |

## Format principles

- **Modal double-faced cards (MDFCs) are the core innovation — draft them highly.** Think of them primarily as lands that sometimes have effects, not spells. The expensive ones (b-minus or better) are the best because: (a) when in your opener they are lands, (b) when top-decked they are powerful spells. "The worst of these are still great." Take the expensive MDFCs (Hagra Mauling, Balagan Recovery, Skyclave Cleric (?), Ondu Inversion) over many good spells.
- **Party baseline = 2.** Evaluate party cards as if you have 2 creatures in your party most of the time. Getting to 3 is common; full party (4) is rare outside dedicated multi-color green builds. Do NOT assume full party when evaluating cards.
- **Blue is the best color.** Its commons are almost all excellent tempo tools — every top blue common involves kicker (Into the Royal, Bubble Snare, Cunning Geyser Mage (?), Risen Riptide). Bias toward blue early, especially blue-black or blue-green.
- **Black's removal is top-tier.** Deadly Allure (?) (scaled murder, b-plus), Blood Chief's Thirst (b-plus), Vanquish the Weak (b-minus), Hagra Mauling (a-minus MDFC) — black has more high-end removal than any other color. This is a major reason to be in black.
- **Red's commons are underwhelming but uncommons are strong.** Roil Eruption (common) and Thundering Rebuke (uncommon, 2 mana deal 4) are the red removal highlights; the rest of red's commons were rated mediocre. Red uncommons (Rockslide Sorcerer, Magmatic Channeler, Shatterskull Charger) are excellent.
- **Creature types matter for party but don't force them.** Blue-white naturally assembles the most types. Don't put bad cards in your deck just to "complete the party" — 2 members is enough for most payoffs.
- **Equipment matters more than it looks.** The auto-equip cycle (Maul of the Skyclaves, Ravager's Mace, Relic Axe, Scavenger's Blade) are auto-equip on ETB; equip costs are steep but the "play creature, get immediate boost" pattern is very strong. Maul of the Skyclaves rated a-minus / b-plus — potentially the best equipment in the set.
- **Be cautious with x/1 creatures.** Multiple effects punish 1-toughness: Subtle Strike (minus-1/-1 on one + counter on yours), the red pinging wizard uncommon (Rockslide Sorcerer), and a mini-sweeper uncommon (Cinder Clasm (?)) can all punish x/1s. Hosts explicitly noted wariness of x/1s in this format.
- **Kicker is a sub-engine, not just upside.** Kicker cards reduce spell variance because they're acceptable both early (unkicked) and late (kicked). Vine Gecko, Risen Riptide, Coral Helm Chronicler, and the b-minus/b land MDFCs all reward kicker-density. In blue-green, actively count your kicker spells (8+ is ideal for Vine Gecko / Roost of Drakes payoffs).
- **Landfall needs density.** You want ~9+ landfall creatures for the synergies to run deep. Scale the Heights (?), Harrow, and the returning-land creatures (Kazandu Stomper, Pyroclastic Hellion (?), Tazeem Raptor) create "extra" landfall triggers — but the deck requires commitment. Don't just splash landfall cards; either build around it or don't.
- **Fixing is available in green.** Reclaim the Wastes (lay the land + kicker), Harrow (sacrifice one land for two basics), Tangled Florohedron (mana dork MDFC), and Lithoform Blight (?) (enchant land) let green-based multi-color decks function. The Pathway dual lands (enemy and allied cycles) are c-plus/high picks when in your colors.
- **Curve advice:** One-drops matter! White one-drops (warrior + cleric) enable the auto-equip pattern. Luminarch Aspirant (put counter on a creature each combat step) is a b-rated two-drop. You want 1-2-3 curves with equipment or removal backup — don't ignore cheap drops in favor of powerful top-end.

## Card notes (community consensus)

All grades are blind predictions. Mark garbled names with (?).
...
- **Blue is undersold heading into week one** — hosts expect people to underrate blue's tempo commons (they're not flashy). Bias toward blue in early packs; cards like Into the Royal, Bubble Snare, and Sea-Floor Stalker may wheel more than they should initially.
- **The kicker lane (blue-green) is likely underdrafted early.** Vine Gecko, Coral Helm Chronicler, and the kicker payoffs require reading the table; if you see Vine Gecko go late, blue-green kicker is open.
- **Cleric payoffs are densely supported at common/uncommon in black-white.** If you're seeing Attended Healer, Marauding Blight-Priest, and Scion of the Swarm going late, the cleric lane is open.
- **Warriors are the most underdrafted tribe** — not because they're bad, but because Nahiri (the main payoff) is rare and the common warriors are unremarkable. Being the only warrior drafter gets you cheap warrior cards late.
- **Full party is hard — don't commit early to party-synergy-only picks.** Stonework Packbeast as a "flexible" party-enabler was predicted to be overdrafted by people trying to force party. Prioritize good cards that happen to have relevant creature types over bad cards that fill your party.
- **Pivoting:** If you start WU, you have the most pivot flexibility — can shift into rogues (black), wizards (red), or stay tempo. If you start Sultai (BUG), you can shift into kicker or rogues. Red-black is the hardest to pivot out of.
- **What wheels:** Landfall bulk (Spitfire Lagac (?), Canopy Baloth (?) etc.), the three-mana 3/3 "brute" green common, utility one-drops without types, and less-focused party cards. The combat tricks (Resolute Strike, Might of Murasa (?)) may go late — pick them up rounds 2-3 once your gameplan is set.

## Supersessions (early-was-wrong, now corrected)

None clearly stated across the sampled episodes. All six episodes were recorded on the same day as blind preview evaluations — there is no later episode to contradict the earlier ones. No supersessions exist in this source set.

## Live disagreements (genuine, unresolved)

- **Stonework Packbeast:** Ethan says C (fine utility card, probably makes your deck), Alex says C-minus. Ethan predicted some community members would rate it "best first pick in the set" — both hosts disagree with that, but Ethan is slightly higher.
- **Feed the Swarm:** Ethan gives the first copy B-minus (black's first enchantment removal); Alex gives it C-plus (thinks other black removal picks higher).
- **Farsight Adept (?):** Ethan gives C-plus (likes the aggressive symmetry-break); Alex gives C (more neutral). Minor disagreement on how often you can exploit the symmetrical draw.
- **Warrior tribe overall:** Ethan more excited about the tribal artifact equipment path; Alex consistently less bullish on warriors as a whole.

## Card-name caveats from caption garble

The auto-caption transcripts heavily mangle proper names. Confident corrections applied; uncertain ones marked (?):

- "deadly lines" → **Deadly Allure** (?) (scalable murder — context clear)
- "hierarch's binding" / "binding of life's grace" → likely **Binding of Life's Grace** or **Archpriest of Iona** — exact name unclear
- "far aside to death" → **Farsight Adept**
- "archpriest of iona" → **Archpriest of Iona** (context clear)
- "kabir outrider" → **Kabira Outrider** (context clear)
- "core blade master" → **Kor Blademaster** (context clear)
- "canyon jabra" / "canyon jerboa" → **Canyon Jerboa** (context clear)
- "kitesail cleric" → **Kitesail Cleric** (?)
- "luminarc aspirin" → **Luminarch Aspirant** (context clear)
- "rockslide source" → **Rockslide Sorcerer** (context clear)
- "kazul's furious" → **Kazul's Fury** (context clear)
- "akum hellhound" → **Akoum Hellhound** (context clear)
- "scoot swarm" / "cute swarm" → **Scute Swarm** (context clear)
- "shia soul of the wild" → **Ashaya, Soul of the Wild** (context clear — 5-mana mythic elemental)
- "grace mall" → **Grakmaw, Skyclave Ravager** (?) (BG 0/0 hydra-death trigger — context suggests this)
- "lin valla shield of the seagate" → **Linvala, Shield of Sea Gate** (context clear)
- "zagros a thief of heartbeats" → **Zagras, Thief of Heartbeats** (context clear)
- "zarath son the trickster" → **Zareth San, the Trickster** (context clear)
- "balagant recovery" → **Bala Ged Recovery** (context clear)
- "colony ambush" → **Vastwood Ambush** (?) (fight MDFC — context clear)
- "vast wood fortification" → **Vastwood Fortification** (context clear)
- "tangled fluorohedron" → **Tangled Florahedron** (context clear)
- "philath world sculptors" → **Phylath, World Sculptor** (context clear)
- "morag fury of acom" → **Moraug, Fury of Akoum** (context clear)
- "nissa of the shadowed bows" → **Nissa of Shadowed Boughs** (context — hosts argued about pronunciation of "boughs")
- "coveted prize" → **Coveted Prize** (clear)
- "drawn assignments" / "drawn on" → **Drana's Silencer** or another black rare — unclear
- "null priest of oblivion" → **Nullpriest of Oblivion** (context clear)
- "taborax hopes demise" → **Taborax, Hope's Demise** (context clear)
- "against the weakening" (?) → likely **Agadeem's Awakening** (black mythic MDFC reanimate multiple creatures)
- "skull smashing" → **Shatterskull Smashing** (context clear)
- "crawling barons" → **Crawling Barrens** (context clear)
- "throne of mckindy" → **Throne of Makindi** (context clear)

## Source episodes

- 2020-09-11 — Zendikar Rising Review: White (eUvvvYIFiSM)
- 2020-09-11 — Zendikar Rising Review: Blue (6INOCjejolU)
- 2020-09-11 — Zendikar Rising Review: Black (XWxMnmE-7Jw)
- 2020-09-11 — Zendikar Rising Review: Red (Tm2F4yaNsFI)
- 2020-09-11 — Zendikar Rising Review: Green (jHAlgpDNzZg)
- 2020-09-11 — Zendikar Rising Review: Gold & Colorless (-VqyvmDofyA)
